...
from APP_Timbrage.collaborateur.gestion_collaborateur_wtf_forms import FormWTFAjouterCollaborateur
from APP_Timbrage.collaborateur.gestion_collaborateur_wtf_forms import FormWTFUpdateCollaborateur
from APP_Timbrage.collaborateur.gestion_collaborateur_wtf_forms import FormWTFDeleteGenre
...
@obj_mon_application.route("/collaborateur_afficher/<string:order_by>/<int:id_collaborateur_sel>", methods=['GET', 'POST'])
@si_user_login
@is_admin
...
@obj_mon_application.route("/collaborateur_ajouter", methods=['GET', 'POST'])
@si_user_login
@is_admin
...
@obj_mon_application.route("/collaborateur_update", methods=['GET', 'POST'])
@si_user_login
@is_admin
def collaborateur_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            return redirect(url_for('collaborateur_afficher', order_by="ASC", id_collaborateur_sel=id_collaborateur_update))
    ...
    return render_template("collaborateur/collaborateur_update_wtf.html", form_update=form_update)


@obj_mon_application.route("/collaborateur_delete", methods=['GET', 'POST'])
@si_user_login
@is_admin
def collaborateur_delete_wtf():
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_annuler.data:
                return redirect(url_for("collaborateur_afficher", order_by="ASC", id_collaborateur_sel=0))
    ...
    return render_template("collaborateur/collaborateur_delete_wtf.html",
